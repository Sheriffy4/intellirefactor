...
class KnowledgeItem:
    ...
    def __init__(self, filename: str, item_type: str, project_name: str, 
                 date_created: str, metadata: Dict[str, Any]):
...
class KnowledgeManager:
    ...
    def __init__(self, config: Optional[KnowledgeConfig] = None, knowledge_dir: str = None):
    ...
    def add_refactoring_metadata(self, metadata_file: str, project_name: str = None) -> bool:
        """
    ...
    def _update_index(self, new_entry: Dict[str, Any]) -> None:
        ...
        if new_entry['filename'] in existing_files:
            ...
            index['total_refactoring_projects'] = index.get('total_refactoring_projects', 0) + 1
    ...
    def _recalculate_statistics(self, index: Dict[str, Any]) -> None:
        ...
        refactoring_files = [f for f in index.get('knowledge_files', []) if f.get('type') == 'refactoring_metadata']
    ...
    def delete_knowledge_item(self, filename: str) -> bool:
        ...
        try:
            ...
            index['knowledge_files'] = [
                f for f in index.get('knowledge_files', []) 
            ...
            if len(index['knowledge_files']) < original_count:
                ...
                index['total_refactoring_projects'] = len([
                    f for f in index['knowledge_files'] 
