...
class ComprehensiveMetadataGenerator(AutomationMetadataGenerator):
    ...
    def generate_comprehensive_metadata(self, project_id: str, project_name: str) -> Dict[str, Any]:
                ...
                "root": {
                    ...
                    "true_branch": {
                        ...
                        "true_branch": {
                            ...
                            "true_branch": {"action": "extract_component", "confidence": 0.9},
                            "false_branch": {"action": "refactor_methods", "confidence": 0.7}
                        },
            ...
            "interface_extraction_tree": {
                "root": {
                    ...
                    "true_branch": {
                        ...
                        "true_branch": {"action": "extract_interface", "confidence": 0.95},
                        "false_branch": {"action": "defer_extraction", "confidence": 0.6}
                    },
                    "false_branch": {
                        "condition": "testing_requires_mocking",
                        "true_branch": {"action": "extract_interface", "confidence": 0.8},
                        "false_branch": {"action": "no_action", "confidence": 0.9}
                    }
                }
            }
    ...
    def demonstrate_automation_recommendations(self, sample_metrics: Optional[Dict] = None) -> List[str]:
        ...
        if sample_metrics.get("cyclomatic_complexity", 0) > 15:
            recommendations.append("High complexity detected - extract methods or components")
        
        if sample_metrics.get("coupling_level", 0) > 0.7:
            recommendations.append("High coupling detected - introduce interfaces and DI")
...
def generate_and_export_comprehensive_metadata(export_path: str, 
                                             project_config: Optional[Dict[str, Any]] = None) -> None:
    ...
    metadata = generator.generate_comprehensive_metadata(
        ...
        "Comprehensive Refactoring Project"
    )
...
def main():
    ...
    try:
        ...
        logger.info(f"Sample code metrics:")
        for metric, value in sample_metrics.items():
            logger.info(f"  - {metric}: {value}")
        
        # Get automation recommendations
        recommendations = generator.demonstrate_automation_recommendations(sample_metrics)
        ...
        logger.info("This metadata can now be used to automate complex refactoring efforts.")
