...
class DeepClassInfo:
    ...
    def is_god_class(self, method_threshold: int = 15, responsibility_threshold: int = 3,
                     cohesion_threshold: float = 0.5) -> bool:
        """Check if class exhibits God Class pattern."""
        return (self.method_count > method_threshold and
                len(self.responsibility_markers) > responsibility_threshold and
                self.cohesion_score < cohesion_threshold)
...
def create_evidence(description: str, confidence: float, 
