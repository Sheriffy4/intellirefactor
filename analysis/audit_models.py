...
class AuditResult:
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'index_result': self.index_result.to_dict() if self.index_result and hasattr(self.index_result, 'to_dict') else None,
            'unused_result': self.unused_result.to_dict() if self.unused_result and hasattr(self.unused_result, 'to_dict') else None,
            'clone_groups': [g.to_dict() if hasattr(g, 'to_dict') else str(g) for g in self.clone_groups],
