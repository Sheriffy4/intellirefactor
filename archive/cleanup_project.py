...
def main():
    ...
    if args.dry_run:
        ...
        print("Files would be moved to: _to_delete/")
        return 0
    ...
    if report.failed_moves:
        ...
        print("You can run the cleanup again later to move remaining files.")

    print("\n✅ Cleanup completed successfully!")
    print(
        f"💡 To restore files: python -c \"from core.refactoring import SafeRemover; SafeRemover().restore_files(Path('{report_path}'))\""
    )
