                ...
                for file in files:
                    if file.endswith(".py") and not file.startswith("_"):
                        ...
                        if self._is_plugin_file(file_path):
                            ...
                            logger.debug(
                                f"Discovered potential plugin: {plugin_name} at {file_path}"
                            )
        ...
        try:
            with open(file_path, "r", encoding="utf-8") as f:
                ...
                return (
                    ...
                    or "AnalysisPlugin" in content
                    or "RefactoringPlugin" in content
                    or "KnowledgePlugin" in content
                    or "ValidationPlugin" in content
                    or "ReportingPlugin" in content
                    or "OrchestrationPlugin" in content
                )
        except Exception:
            return False
