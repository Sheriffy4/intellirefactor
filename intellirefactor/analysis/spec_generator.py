...
class SpecGenerator:
        ...
        for section in template.sections:
            if section == "header":
                ...
                if quality_findings or performance_findings:
                    content.extend(
                        self._generate_quality_performance_section(
                            quality_findings, performance_findings
                        )
                    )
    ...
    def _generate_critical_findings_section(
        self, critical_findings: List[AuditFinding]
    ) -> List[str]:
    ...
    def _generate_quality_performance_section(
        self,
