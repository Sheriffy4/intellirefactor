...
from intellirefactor.analysis.foundation.models import BlockInfo, BlockType, FileReference
...
class BlockExtractor:
    ...
    def extract_blocks(self, source_code: str, file_path: str) -> List[BlockInfo]:
        ...
        """
        # IMPORTANT:
        # Some files may be saved as UTF-8 with BOM. When we receive a string and call ast.parse(),
        # the BOM may appear as U+FEFF and cause SyntaxError: "invalid non-printable character U+FEFF".
        # Strip it to make parsing robust.
