...
class IntelliRefactor:
    ...
    def _initialize_components(self) -> None:
        ...
        try:
            ...
            self._components['refactoring_system'] = IntelligentRefactoringSystem(self.config.refactoring_settings)
            ...
            self._components['validator'] = RefactoringValidator(self.config.refactoring_settings)
    ...
    def initialize_project(self, project_path: Union[str, Path]) -> Dict[str, Any]:
        ...
        try:
            ...
            if 'safety_manager' in self._components:
                results['components']['safety'] = self._components['safety_manager'].initialize_project(project_path)
            ...
            if 'knowledge_manager' in self._components:
                ...
                if hasattr(km, 'initialize_project_knowledge'):
                    results['components']['knowledge'] = km.initialize_project_knowledge(project_path)
                else:
                    # Default behavior if specific init not needed
                    results['components']['knowledge'] = {'status': 'ready', 'path': km.knowledge_dir}
    ...
    def analyze_project(self, project_path: Union[str, Path], 
                       ...
                       include_opportunities: bool = True) -> AnalysisResult:
        """
        ...
        if not self._initialized:
            ...
            return AnalysisResult(False, {}, [error.message], [], {'error_details': error.to_dict()})
        ...
        try:
            ...
            project_analysis_result = self._components['project_analyzer'].analyze_project(str(project_path))
            ...
            if include_opportunities:
                try:
                    raw_opportunities = self._components['refactoring_system'].identify_opportunities(analysis_data)
    ...
    def analyze_file(self, file_path: Union[str, Path], project_root: Optional[Path] = None) -> AnalysisResult:
        """
        ...
        try:
            ...
            file_analysis_result = self._components['file_analyzer'].analyze_file(
                str(file_path), 
                external_context=external_index
            )
    ...
    def identify_opportunities(self, project_path: Union[str, Path], 
    ...
    def apply_refactoring(self, opportunity: Dict[str, Any], 
                         dry_run: bool = False,
                         validate_results: bool = True) -> RefactoringResult:
        ...
        try:
            ...
            result = self._components['auto_refactor'].apply_opportunity(opportunity, dry_run=dry_run)
    ...
    def auto_refactor_project(self, project_path: Union[str, Path], 
                             strategy: Optional[str] = None,
                             max_operations: Optional[int] = None,
                             dry_run: bool = False) -> RefactoringResult:
        ...
        try:
            ...
            result = self._components['auto_refactor'].refactor_project(str(project_path), strategy, dry_run=dry_run)
    ...
    def generate_report(self, results: List[RefactoringResult], 
    ...
    def format_error(self, error_details: Dict[str, Any], format_type: str = 'text') -> str:
        ...
        try:
            ...
            from .analysis.error_handler import AnalysisError, ErrorCategory, ErrorSeverity
    ...
    def _find_project_root(self, file_path: Path) -> Optional[Path]:
        ...
        for _ in range(5):
            ...
            project_markers = [
                ...
                '__init__.py', '.git', 'README.md', 'Pipfile',
