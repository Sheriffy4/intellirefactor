...
class RefactoringValidator:
    ...
    def __init__(self, project_root: Path = None):
        ...
        self.expected_docs = ["PROJECT_STRUCTURE.md", "MODULE_REGISTRY.md", "LLM_CONTEXT.md"]
    ...
    def _check_llm_context_content(self) -> ValidationResult:
        ...
        required_patterns = [
            ...
            (
                r"перед созданием.*функционал|before creating.*functionality",
                "check before creating functionality rule",
            ),
...
def main():
    ...
    parser = argparse.ArgumentParser(description="Валидатор результатов глобального рефакторинга")
