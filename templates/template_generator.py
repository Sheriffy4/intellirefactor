...
class TemplateGenerator:
    ...
    def get_template_path(cls, template_name: str, format: str = 'json') -> Path:
        ...
        if template_name not in cls.AVAILABLE_TEMPLATES:
            raise ValueError(f"Unknown template: {template_name}. Available: {list(cls.AVAILABLE_TEMPLATES.keys())}")
    ...
    @classmethod
    def generate_config(cls, template_name: str, 
                       output_path: str,
                       format: str = 'json',
                       customizations: Optional[Dict[str, Any]] = None) -> None:
        """
    ...
    def create_custom_template(cls, 
                              ...
                              safety_level: str = 'moderate') -> Dict[str, Any]:
        """
        ...
        if quality_thresholds:
            ...
            if 'cyclomatic_complexity' in quality_thresholds:
                template_data['analysis']['complexity_threshold'] = quality_thresholds['cyclomatic_complexity'] * 1.5
...
def main():
    ...
    parser.add_argument('template', choices=list(TemplateGenerator.AVAILABLE_TEMPLATES.keys()),
