...
class RichOutputManager:
    ...
    def add_tree_node(self, tree: Union['Tree', Dict], label: str, parent: Optional[Union['Tree', Dict]] = None) -> Union['Tree', Dict]:
    ...
    def add_progress_task(self, progress: Union['Progress', Dict], description: str, total: int) -> Union[TaskID, str]:
    ...
    def update_progress(self, progress: Union['Progress', Dict], task_id: Union[TaskID, str], advance: int = 1) -> None:
        """Update progress."""
    ...
    def _build_file_tree(self, parent_node: Union['Tree', Dict], path: Path, current_depth: int, max_depth: int) -> None:
